...
class TestResizeResultsToBudgets(unittest.TestCase):
    def test_defined_risk_scales_down_to_margin_budget(self):
        ...
        self.assertLessEqual(result.max_loss, ctx.max_loss_rupees or 0)
    ...
    def test_infinite_loss_mode_sizes_defined_risk_by_margin_only(self):
        ...
        asyncio.run(
            resize_results_to_budgets(
                ...
                "16-Jun-2026",
                [capped],
                _ctx(max_loss_rupees=4_000, margin_rupees=500_000, allow_infinite_loss=False),
            )
        )
        ...
        asyncio.run(
            resize_results_to_budgets(
                ...
                "16-Jun-2026",
                [infinite],
                _ctx(max_loss_rupees=None, allow_infinite_loss=True, margin_rupees=500_000),
            )
        )
