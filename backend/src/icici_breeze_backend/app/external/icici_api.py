...
def fetch_customerdetails_session_token(api_key: str, broker_token: str) -> str:
...
def call_icici_api_direct(
    ...
    if user_id:
        try:
            from icici_breeze_backend.app.services.api_usage import record_call as _record_usage
