...
export const sb = {
  ...
  parameterCard:
    "flex h-full flex-col gap-4 rounded-lg border border-zinc-200/80 bg-zinc-50/50 p-4 dark:border-zinc-700/80 dark:bg-zinc-950/40",
  parameterCardTitle:
