...
export const sb = {
  ...
  btnDanger:
    "inline-flex items-center justify-center rounded-lg bg-red-600 px-3.5 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-red-700 focus:outline-none focus-visible:ring-4 focus-visible:ring-red-500/30 dark:bg-red-600 dark:hover:bg-red-500",
  tableSelect:
  ...
  cardTemplate:
    "rounded-lg border border-zinc-200/90 bg-gradient-to-b from-white to-zinc-50/80 p-3.5 text-left text-xs text-zinc-950 shadow-sm transition hover:border-zinc-300 hover:shadow-md disabled:opacity-50 dark:border-zinc-700 dark:from-zinc-900 dark:to-zinc-950/80 dark:text-zinc-50 dark:hover:border-zinc-600",
  cardTemplateAmber:
