  ...
  if (outlook === "bearish") {
    return (
      <svg
        ...
        fill="currentColor"
      >
        <path fillRule="evenodd" clipRule="evenodd" d={BEAR_PATH} />
      </svg>
    );
  }
